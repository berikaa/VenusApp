...
public class TaramaActivity extends AppCompatActivity {
    ...
    private FrameLayout insideFrame;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setPath();
        // set view
        scan=(Button)findViewById(R.id.button_tara);
        insideFrame=(FrameLayout)findViewById(R.id.inside_frame);
        captureImage=(ImageView)findViewById(R.id.imageView);
    ...
    private void  setBitmap(Bitmap original) {
        scaledBitmap= scaledBitmap(original, insideFrame.getWidth(), insideFrame.getHeight());
        ...
        private void readWithTesseract(final Bitmap scaningImage){
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    tessBaseAPI.end();
                    progressDialog.dismiss();
                    Intent goruntu = new Intent(getApplicationContext(), GoruntuActivity.class);
